...
import { useArtistTopTracks } from "../context/artist-page-context";

export const TopTrackList = () => {
  const tracks = useArtistTopTracks();
            ...
            >
              ...
              <div className="flex items-center gap-3 overflow-hidden">
                ...
                <div className="flex flex-col truncate">
                  <span className="truncate text-base text-white group-hover:text-white">{track.name}</span>
                </div>
              </div>

              <div className="text-sm text-right text-text-subdued">{track.formattedPlaycount}</div>
              ...
              <div className="flex items-center justify-end gap-3 text-sm pr-2 text-text-subdued">
                <span>{track.duration.formatted}</span>
