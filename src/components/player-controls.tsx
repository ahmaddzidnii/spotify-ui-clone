  ...
  return (
    <div className="flex flex-col items-center w-full   ">
      ...
      <div className="flex items-center justify-center gap-4 mb-2">
        {/* Shuffle Button */}
        <button
          className="p-2 hover:scale-105 transition-transform text-[#b3b3b3] hover:text-white"
          aria-label="Shuffle"
        >
          <svg
            role="img"
        ...
        {/* Previous Button */}
        <button
          className="p-2 text-[#b3b3b3] hover:text-white hover:scale-105 transition-all"
          aria-label="Previous"
        >
          <svg
            role="img"
      ...
      <div className="flex items-center gap-2 w-full">
        ...
        <div className="flex-1 group relative">
          <div className="h-1 bg-[#4d4d4d] rounded-full overflow-hidden">
            <div
              className="h-full bg-white rounded-full transition-all group-hover:bg-green-500 relative"
